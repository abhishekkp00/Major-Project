...
def generate_baseline_adapters() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        "trusted_clean": {
            ...
            "label_malicious": 0,
            "desc": "Synthetic clean mock adapter baseline (isolated research test fixture)",
            "trigger_force": False,
        },
        "ordinary_noisy": {
            ...
            "ref_weights": clean_ref,
            "label_malicious": 0,
            "desc": "Synthetic random noisy mock adapter baseline (isolated research test fixture)",
            "trigger_force": False,
        },
        "struct_modified": {
            ...
            "ref_weights": clean_ref,
            "label_malicious": 1,
            "desc": "Synthetic structural outlier mock adapter (isolated research test fixture)",
            "trigger_force": False,
        },
        "controlled_trigger": {
            ...
            "ref_weights": clean_ref,
            "label_malicious": 1,
            "desc": "Controlled trigger-conditioned mock test adapter (isolated research test fixture)",
            "trigger_force": True,
        },
    }
